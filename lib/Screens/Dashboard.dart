...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    _controller.addListener(() {
      if (startedPlaying && !_controller.value.isPlaying) {
        // Your logic when video stops playing
      }
    });
    _controller.setLooping(true);
  }
                        ...
                        child: ListView(
                          ...
                          children: [
                            Container(
                              ...
                              child: Center(
                                child: Container(
                                  // Your FutureBuilder for video
                                ),
                              ),
                            ),
                            // Rest of the image containers
                          ],
                        ),
                      ),
                      Expanded(
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // ElevatedButtons for calling (buttonLabels)
                            ],
                          ),
                        ),
                      ),
