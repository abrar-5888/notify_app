...
import 'package:flutter/material.dart';
import 'package:flutter_easyloading/flutter_easyloading.dart';
// import 'package:firebase_auth/firebase_auth.dart'; // Commented out Firebase Auth import
// import 'package:cloud_firestore/cloud_firestore.dart'; // Commented out Cloud Firestore import
import 'package:shared_preferences/shared_preferences.dart';
...
class _FamilyMembersState extends State<FamilyMembers> {
  // Commented out Firebase Auth instance
  // final _auth = FirebaseAuth.instance;
  var emailaddress;
  var password;
  var name;
  ...
  submit() async {
    ...
    try {
      ...
      try {
        // Commented out Firestore queries
        // var userrecord = FirebaseFirestore.instance
        //     .collection("UserRequest")
        //     .where('ownermail', isEqualTo: _auth.currentUser!.email)
        //     .get()
        ...
        // Commented out Firebase Auth and Firestore operations
        // final newUser = await _auth.createUserWithEmailAndPassword(
        //     email: emailaddress, password: password);
